...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/search') {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_BloggerBlogBundle_search;
            }
            return array (  '_controller' => 'Blogger\\BlogBundle\\Controller\\PageController::searchAction',  '_route' => 'BloggerBlogBundle_search',);
        }
        not_BloggerBlogBundle_search:

        // BloggerBlogBundle_index2
        if ($pathinfo === '/index2') {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_BloggerBlogBundle_index2;
            }
            return array (  '_controller' => 'Blogger\\BlogBundle\\Controller\\PageController::index2Action',  '_route' => 'BloggerBlogBundle_index2',);
        }
        not_BloggerBlogBundle_index2:
